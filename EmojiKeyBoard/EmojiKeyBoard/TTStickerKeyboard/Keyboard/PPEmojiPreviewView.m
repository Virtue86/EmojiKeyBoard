...
- (void)layoutSubviews
{
    ...
    self.emojiImageView.image = [UIImage imageNamed:[@"EmojiPackage.bundle" stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@",_emoji.folderName, _emoji.imageName]]];
